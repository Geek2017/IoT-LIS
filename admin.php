	...
	<body>
		...
		<div id="main-wrapper">
							...
							<article class="inner">
								<div class="row">
                                    ...
                                    <div class="form-group col-12" style="border:double">
										...
										<div class="form-group col-3">
											<label for="pdn" title="Example:  Police Department">Police Department Name: [<strong>?</strong>]</label>
			...
			<?php require_once("sidebar.php"); ?>
				<footer>
					<p class="copyright">&copy; Copyright 2017 <a href="https://pacificblue.legazpi.ph/" target="_blank">Pacific Blue IT</a></p>
				</footer>
			</div>
		</div>
